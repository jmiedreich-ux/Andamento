...
- Local gates on `main`: `npm test` **78/78**, `npm run test:e2e` **10/10**, `npm audit --audit-level=high` **0 vulnerabilities**, **23** runtime invariants passing. Seven ordered migrations.
